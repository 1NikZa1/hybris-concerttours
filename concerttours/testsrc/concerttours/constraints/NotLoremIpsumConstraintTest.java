...
public class NotLoremIpsumConstraintTest extends ServicelayerTransactionalTest {
    ...
    public void testLoremIpsumConstraint() {
        ...
        assertTrue("The violation set sould not be null or empty", violations != null && violations.size() > 0);
        ...
        for (final HybrisConstraintViolation hybrisConstraintViolation : violations) {
            assertEquals(NotLoremIpsumConstraintModel.class, hybrisConstraintViolation.getConstraintModel().getClass());
        }
    }
}